(function () {
    ...
    return `
      <div class="tab-panel-grid">
        ...
        <div class="panel-card span-12">
          <h4>Investment framing</h4>
          <p>${data.metadata.managementMessage}</p>
          <div class="badge-row">
            <div class="badge good">Default to conservative underwritten case</div>
            <div class="badge">Scenario analysis enabled</div>
            <div class="badge warn">Optional revenue layers separated from the base case</div>
            <div class="badge">Phased site-by-site rollout</div>
          </div>
        </div>
      </div>
    `;
  ...
  function renderStrategyTab(metrics) {
    return `
      <div class="tab-panel-grid">
        <div class="panel-card span-6">
          <h4>What this dashboard is designed to show</h4>
          <ul class="muted-list">
        ...
        <div class="panel-card span-6">
          <h4>Reference case & materials</h4>
          <div class="matrix-list">
            ...
            <div class="matrix-row"><div class="key">Platform path</div><div>${data.metadata.contractsHorizon}</div></div>
          </div>
    ...
    return `
      <div class="tab-panel-grid">
        <div class="panel-card span-6">
          ...
          <p class="microcopy">Interactive funding outputs flex the equity and debt mix around the scenario assumptions shown in the control panel.</p>
        </div>
        <div class="panel-card span-6">
    ...
    return `
      <div class="tab-panel-grid">
        ...
        <div class="panel-card span-5">
          ...
          <a class="secondary-btn full top-gap" href="${data.modelDownloadUrl}" target="_blank" rel="noopener">Open 10-year model</a>
        </div>
      </div>
    `;
  }
